...
def data_loader(data_name, sampling_rate, year, disease_id, begin_year, mse_weight):
  seed = 25
  ...
  data_weight = np.ones((N1, N3), dtype='float64')
  ...
  for idx_m in range((begin_year-2008),N3-1):
    ...
    for i in range(N1):
      ...
      data_weight[i, idx_m] = mse_weight

  return data_x, miss_data_x, data_m, ward_nor_list,ward_list,ward_code_list,data_weight