...
def main (args, year, disease_id, begin_year):
    ...
    ori_data_x, miss_data_x, data_m, ward_nor_list, ward_list, ward_code_list,data_weight = data_loader(data_name, sampling_rate, year, disease_id, begin_year, gain_parameters['mse_weight'])

    # Impute missing data
    imputed_data_x = gain(miss_data_x, gain_parameters, data_weight, ward_list, ward_nor_list)
...
if __name__ == '__main__':
    ...
    for year in range(2008,2018):
        ...
        parser.add_argument(
          '--mse_weight',
          help='weight of completion point',
          default=0.8,
          type=float)
        parser.add_argument(
          '--hint_rate',
        ...
        for count in range(10):
            ...
            RMSE, MAE, MAPE, ward_code_list, R_result = main(args, year, disease_id, begin_year)
        ...
        df_csv = pd.DataFrame()
        file_name_csv = "GAIN_Obesity_begin_year_" + str(begin_year) \
